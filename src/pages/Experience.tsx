      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            My journey in tech spans from building scalable software to uncovering insights from data — across multiple industries and roles.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          {experiences.map((exp, index) => (
            <div key={index} className={`relative flex items-center mb-12 ${
              ...
              {/* Dot */}
              <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-4 h-4 bg-blue-700 rounded-full border-4 border-white shadow-md z-10"></div>
              ...
              <div className={`ml-12 md:ml-0 md:w-5/12 ${index % 2 === 0 ? 'md:mr-auto md:pr-8' : 'md:ml-auto md:pl-8'}`}>
                <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-100">
                  ...
                  <ul className="space-y-2 mb-4 list-disc list-inside text-gray-700 text-sm leading-relaxed">
